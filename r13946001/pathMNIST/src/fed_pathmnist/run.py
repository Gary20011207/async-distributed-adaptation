...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--dataset",
        default="pathmnist",
        help="2D MedMNIST dataset key, e.g. pathmnist, pneumoniamnist, bloodmnist.",
    )
    parser.add_argument(
        "--model",
        choices=["resnet18", "small_cnn", "mobilenet_v3_small"],
        default="resnet18",
        help="Classifier backbone used by all clients and the server.",
    )
